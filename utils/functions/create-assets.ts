interface Parameters {
  ...
  overrides?: any;
  callbacks?: {
    [index: string]: (this: GlobalEventHandlers, ev: Event) => any;
  }
}


export function createAssets(obj: Parameters) {
  let { currentElement, overrides, callbacks } = obj;
  ...
  edqScript.onload = function(event) { 
    ...
    let useTypedown = useTypedownIndicator &&
