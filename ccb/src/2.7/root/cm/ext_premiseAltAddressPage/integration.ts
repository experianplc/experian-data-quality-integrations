...
let currentElement = document.getElementById("edq-2.7-root-cm-ext_premiseAltAddressPage");

let interval = setInterval(function() {
  if (document.getElementById("PREM_ALT$ADDRESS1")) {
    ...
    const config = Object.assign({
      PRO_WEB_TYPEDOWN_TRIGGER: document.getElementById('PREM_ALT$ADDRESS1'),
      ...
      GLOBAL_INTUITIVE_ELEMENT: document.getElementById('PREM_ALT$ADDRESS1'),
